...
def read_codeml_output(filename):
    """Parse the 'rst' file returned by codeml. Returns Maximum Likelihood
    (ML) and ML+1 residues for all ancestors, and their posterior probability.
    ...
    tree : dendropy.Tree
        Tree object with ancestors and tips labelled. Keeps branch length as
        well.
    """
    # Read paml output.
